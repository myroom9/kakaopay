...
@Slf4j
@Component
public class MemberPointInformationUseFacade extends MemberPointInformationAbstract {
    ...
    public MemberPointInformationUseFacade(MerchantService merchantService, BarcodeService barcodeService, PointTransactionHistoryService pointTransactionService, MemberPointInformationService memberPointInformationService) {
    ...
    public MemberPointInformation handlePoint(Merchant merchant, Barcode barcode, BigDecimal point) {
        ...
        return memberPointInformationService.use(saveRequest);
    }
    ...
    public void savePointTransactionHistory(Member member, Merchant merchant, BigDecimal point) {
        PointTransactionSaveRequest pointTransactionSaveRequest =
                PointTransactionSaveRequest.fromEntity(member, merchant, point, PointTransactionType.USE);
