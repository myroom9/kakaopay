...
@SpringBootTest
@Transactional
class MemberPointInformationSaveFacadeTest {
    @Autowired
    ...
    void doProcessPointSuccessTest() {
        ...
        MemberPointInformation result = memberPointInformationSaveFacade.handlePoint(merchant, barcode, clientRequest.getPoint());
    ...
    void savePointIsNotExistMerchantTest() {
        ...
        BusinessException exception = assertThrows(BusinessException.class, () -> {
            memberPointInformationSaveFacade.doProcessPoint(clientRequest);
        });
